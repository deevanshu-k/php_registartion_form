...
$all = " SELECT * FROM student_info where ScholarNo='$schno'";
        ...
        <form action="#" method="POST" enctype="multipart/form-data">
            ...
            <div class="column">
                <div class="item">
                    ...
                    <input id="scholar" type="text" value=<?php echo $row['ScholarNo']; ?> name="studentscholar" required />
                </div>
            ...
            <div class="column">
                ...
                <div class="item">
                    <label for="bdate" style="font-weight: 600;">Date of Birth</label>
                    <input id="bdate" type="date" name="dateofbirth" />
