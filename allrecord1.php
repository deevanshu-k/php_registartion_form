...
<body style="background-image: url('images/bg-01.jpg');">
    ...
    $all = " SELECT * FROM student_info ORDER BY 'StudentName' ASC";

    $alldata = mysqli_query($con, $all);
    ...
    if ($totalrow != 0) {
    ?>
        <table class="student_table" width = "100%">
            <tr>
                <th>Student Name</th>
                <th>Scholar No</th>
                <th>Email</th>
        ...
        while ($finalresult = mysqli_fetch_assoc($alldata)) {
            ...
            echo "<tr>
                          <td>" . $finalresult['StudentName'] . "</td>
                          <td>" . $finalresult['ScholarNo'] . "</td>
                          <td>" . $finalresult['Email'] . "</td>
                          <td>" . $finalresult['CollegeName'] . "</td>
                          <td>" . $finalresult['CourseName'] . "</td>
                          <td>" . $finalresult['Branch'] . "</td>
                          <td>" . $finalresult['FatherName'] . "</td>

                          <td><a href='update.php?scholar=$finalresult[ScholarNo]'>Update</a> </td>
                        </tr>";
        }
    } else {
